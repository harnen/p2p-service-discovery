...
/**
 * Message class provide all functionalities to manage the various messages, principally LOOKUP
 * messages (messages from application level sender destined to another application level).<br>
 * Types Of messages:<br>
 * (application messages)<br>
 * - MSG_LOOKUP: indicates that the body Object contains information to application level of the
 * recipient<br>
 * <br>
 ...
 * many pastry nodes according to the protocol<br>
