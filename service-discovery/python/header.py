features = {'size': {'type': 'benign', 'default': 5000, 'keyword': 'SIZE', 'vals':[5000, 25000, 50000]},
            'topic': {'type': 'benign', 'default': 10, 'keyword': 'control.0traffic.maxtopicnum', 'vals':[50,300,600]},
