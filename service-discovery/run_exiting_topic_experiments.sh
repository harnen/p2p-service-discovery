...
function run_sim(){
    OUT_CONFIG="config/discv5_attackspam_topic${TOPIC}_${UNIFORM}_attackerPercent${PERCENT_EVIL}.cfg"
    ...
    LOG_FILE="logs_discv5_attackTopic${TOPIC}_${UNI}_attackPercent${PERCENT_EVIL}"
