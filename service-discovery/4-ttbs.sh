...
DEF_BUCKET_SIZE=17
DEF_BUCKET_ORDER=1
DEF_TICKET_TABLE_BUCKET_SIZE=17
DEF_SEARCH_TABLE_BUCKET_SIZE=17
...
BUCKET_ORDERS='0 1 2'
TICKET_TABLE_BUCKET_SIZES='3 10 17'
...
restore_def
for TICKET_TABLE_BUCKET_SIZE in $TICKET_TABLE_BUCKET_SIZES
do
